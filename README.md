...
Copy the config file `fcm.php` manually from the directory `/vendor/rahulthapaofficial/laravel-fcm/config` to the directory `/config ` (you may need to create this directory).
